...
const SOUND_COMMANDS: Record<string, Record<SoundType, string>> = {
    linux: {
        warning: 'paplay /usr/share/sounds/freedesktop/stereo/dialog-warning.oga 2>/dev/null || aplay /usr/share/sounds/freedesktop/stereo/dialog-warning.oga 2>/dev/null || echo -e "\\a"',
        critical: 'paplay /usr/share/sounds/freedesktop/stereo/dialog-error.oga 2>/dev/null || aplay /usr/share/sounds/freedesktop/stereo/dialog-error.oga 2>/dev/null || echo -e "\\a"',
    },
    darwin: {
